...
-- Wrapping parser into new type
-- Use 'Parser a' to wrap 'a' into Parser
-- Use 'runparser Parser a' to unwrap 'a' from Parser
...
jsonNumber = f <$> notNull (spanP isDigit) where f ds = JsonNumber $ read ds
